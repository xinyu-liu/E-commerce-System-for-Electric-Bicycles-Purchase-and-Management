...
while(   $row1=mysql_fetch_assoc($res1) ) {
	$count=0;
	$hasProduct=0;	
	echo '<table cellpadding="10"><tr><th colspan="120" >'.$row1['productCategoryName'].'</th></tr>';
	...
	while( $row2=mysql_fetch_assoc($res2) ) {
		...
		echo '<li><img src="'.$image_file.'" width=250 height=250 style="vertical-align:middle"></li>';
	...
	if($reminder!=0 && $hasProduct==0){// if($reminder==0) && null inside catigory
